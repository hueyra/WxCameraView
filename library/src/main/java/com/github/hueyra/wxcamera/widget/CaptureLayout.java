...
import com.github.hueyra.wxcamera.listener.ClickListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private String getCaptureTip() {
        ...
        switch (buttonFeatures) {
            case WxCameraConfig.BUTTON_STATE_ONLY_CAPTURE:
                return getContext().getString(R.string.wx_camera_only_capture);
            case WxCameraConfig.BUTTON_STATE_ONLY_RECORDER:
    ...
    public void setCaptureBothAll() {
        setButtonFeatures(WxCameraConfig.BUTTON_STATE_BOTH);
    }

    public void setCaptureOnlyCapture() {
        setButtonFeatures(WxCameraConfig.BUTTON_STATE_ONLY_CAPTURE);
    }

    public void setCaptureOnlyRecorder() {
        setButtonFeatures(WxCameraConfig.BUTTON_STATE_ONLY_RECORDER);
    }
