package com.github.hueyra.wxcamera.util;
...
public class Utils {
    ...
    public static int getRecordState() {
        ...
        try {
            ...
            return WxCameraConfig.CHECK_PERMISSION_STATE_NO_PERMISSION;
        }
        if (audioRecord.getRecordingState() != AudioRecord.RECORDSTATE_RECORDING) {
            ...
            return WxCameraConfig.CHECK_PERMISSION_STATE_RECORDING;
        } else {
            //检测是否可以获取录音结果
            ...
            if (readSize <= 0) {
                ...
                return WxCameraConfig.CHECK_PERMISSION_STATE_SUCCESS;
            }
        }
    }

    public static void createMediaDirs(Context context) {
        File file = context.getExternalFilesDir(WxCameraConfig.EXTERNAL_FILES_DIR_NAME);
